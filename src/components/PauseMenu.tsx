...
const MOVE_LIST = [
  ...
  { category: 'ATAQUES', moves: [
    ...
    { name: 'Temblor (Aire+↓+Golpe)', p1: 'S+F (aire)', p2: '↓+[ (aire)' },
    { name: 'Gancho hacia abajo (Aire+→+Golpe)', p1: 'D+F (aire)', p2: '→+[ (aire)' },
    { name: 'Especial (Cristal)', p1: 'G', p2: ']' },
    { name: 'Invocación Cristal (→+Especial)', p1: 'D+G', p2: '→+]' },
    { name: 'Rebote Cristal (↓+Especial)', p1: 'S+G', p2: '↓+]' },
    { name: 'Cristal Curva (↑+Especial)', p1: 'W+G', p2: '↑+]' },
